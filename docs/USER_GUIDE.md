...
![Пример текстового сообщения](screenshots/raw/report_v2_-005.png)
...
![Результат matching](screenshots/raw/report_v2_-010.png)
...
![Пример голосового сообщения](screenshots/raw/report_v2_-006.png)
...
![Пример PDF-файла](screenshots/raw/report_v2_-008.png)

*Пример PDF-резюме в Telegram*
...
![Пример фото резюме](screenshots/raw/report_v2_-007.png)
...
![Голосовая версия результата](screenshots/raw/report_v2_-012.png)

*Пример голосового сообщения (TTS)*

**Визуальные материалы:**

![Визуальная карточка кандидата](screenshots/raw/report_v2_-013.png)

*Визуальная карточка с профилем кандидата и результатами matching*

**Видео-результат:**

![Пример видео-результата](screenshots/raw/report_v2_-014.png)
