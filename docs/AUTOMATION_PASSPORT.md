...
История версий и изменений системы ведётся в едином журнале [`📝 CHANGE_LOG.md`](CHANGE_LOG.md) (раздел «История версий»); текущая версия — в разделе «🪪 1. Идентификация».
