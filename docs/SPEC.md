...
Единственный реестр дефектов — [known-issues.md](known-issues.md). Отражение в SPEC:

| ID | Проблема | Статус | Место в SPEC |
|----|----------|--------|--------------|
| KP-001 | Несовместимость metadata | ✅ Fixed (2026-09-01) | Фикс реализует FR-016 «Контракт metadata» |
| KP-002 | Bot token в репозитории | ✅ Fixed (2026-06-24) | NFR-008 |
