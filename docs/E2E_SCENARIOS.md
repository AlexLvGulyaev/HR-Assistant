...
## 📷 1. Сценарий: Фото резюме → Matching
...
## 🎙️ 2. Сценарий: Голосовое резюме → Matching
...
## 📎 3. Сценарий: Документ (PDF) → Matching
...
## ⌨️ 4. Сценарий: Текстовое резюме → Matching
