...
2. Создать CHANGE_LOG.md для отслеживания изменений
3. Документировать процесс версионирования workflow

**Требуется:**

- [x] Git-версионирование workflow (`workflows/` в репозитории)
- [x] CHANGE_LOG.md ведётся
- [ ] Документировать процесс версионирования workflow
...
Входные материалы кейса находились в корне проекта.
...
Переместить во входные материалы кейса (вне публичной поставки).
...
|----|-----------|--------|------|
| KP-001 | 🔴 Critical | ✅ Fixed (2026-09-01) | 2026-06-23 |
| KP-002 | ⚠️ Medium | ✅ Fixed (2026-06-24) | 2026-06-23 |
| KP-003 | ⚠️ Medium | Open | 2026-06-23 |
| KP-004 | ℹ️ Low | ✅ Fixed (2026-06-23) | 2026-06-23 |
