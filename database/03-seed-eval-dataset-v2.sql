-- ============================================================
-- HRA-EVAL-V2: Evaluation Dataset for Matching Prompt (v2)
...
VALUES (
    gen_random_uuid(),
    'HRA-EVAL-V2',
    'Matching Prompt Evaluation Dataset v2',
...
SELECT gen_random_uuid(), d.id, 'HRA-EVAL-V2-000001', 'obvious_match',
...
FROM eval_prompt_datasets d WHERE d.dataset_code = 'HRA-EVAL-V2';

-- Кейс 2: Prompt Engineer → подходит к вакансии "Prompt Engineer"
INSERT INTO eval_prompt_cases (
    id, dataset_id, case_code, case_type, candidate_json, notes, created_at
)
SELECT gen_random_uuid(), d.id, 'HRA-EVAL-V2-000002', 'obvious_match',
...
SELECT gen_random_uuid(), d.id, 'HRA-EVAL-V2-000003', 'obvious_match',
...
SELECT gen_random_uuid(), d.id, 'HRA-EVAL-V2-000004', 'obvious_match',
...
SELECT gen_random_uuid(), d.id, 'HRA-EVAL-V2-000005', 'obvious_match',
...
SELECT gen_random_uuid(), d.id, 'HRA-EVAL-V2-000006', 'obvious_match',
...
SELECT gen_random_uuid(), d.id, 'HRA-EVAL-V2-000007', 'obvious_match',
...
SELECT gen_random_uuid(), d.id, 'HRA-EVAL-V2-000008', 'obvious_match',
...
SELECT gen_random_uuid(), d.id, 'HRA-EVAL-V2-000009', 'obvious_match',
...
SELECT gen_random_uuid(), d.id, 'HRA-EVAL-V2-000010', 'obvious_match',
...
SELECT gen_random_uuid(), d.id, 'HRA-EVAL-V2-000011', 'obvious_no_match',
...
SELECT gen_random_uuid(), d.id, 'HRA-EVAL-V2-000012', 'obvious_no_match',
...
SELECT gen_random_uuid(), d.id, 'HRA-EVAL-V2-000013', 'obvious_no_match',
...
SELECT gen_random_uuid(), d.id, 'HRA-EVAL-V2-000014', 'obvious_no_match',
...
SELECT gen_random_uuid(), d.id, 'HRA-EVAL-V2-000015', 'obvious_no_match',
...
SELECT gen_random_uuid(), d.id, 'HRA-EVAL-V2-000016', 'obvious_no_match',
...
SELECT gen_random_uuid(), d.id, 'HRA-EVAL-V2-000017', 'obvious_no_match',
...
SELECT gen_random_uuid(), d.id, 'HRA-EVAL-V2-000018', 'obvious_no_match',
...
SELECT gen_random_uuid(), d.id, 'HRA-EVAL-V2-000019', 'obvious_no_match',
...
SELECT gen_random_uuid(), d.id, 'HRA-EVAL-V2-000020', 'obvious_no_match',
...
SELECT gen_random_uuid(), d.id, 'HRA-EVAL-V2-000021', 'borderline',
...
SELECT gen_random_uuid(), d.id, 'HRA-EVAL-V2-000022', 'borderline',
...
SELECT gen_random_uuid(), d.id, 'HRA-EVAL-V2-000023', 'borderline',
...
SELECT gen_random_uuid(), d.id, 'HRA-EVAL-V2-000024', 'borderline',
...
SELECT gen_random_uuid(), d.id, 'HRA-EVAL-V2-000025', 'borderline',
...
SELECT gen_random_uuid(), d.id, 'HRA-EVAL-V2-000026', 'borderline',
...
SELECT gen_random_uuid(), d.id, 'HRA-EVAL-V2-000027', 'borderline',
...
SELECT gen_random_uuid(), d.id, 'HRA-EVAL-V2-000028', 'borderline',
...
SELECT gen_random_uuid(), d.id, 'HRA-EVAL-V2-000029', 'borderline',
...
SELECT gen_random_uuid(), d.id, 'HRA-EVAL-V2-000030', 'borderline',
...
WHERE d.dataset_code = 'HRA-EVAL-V2'
  AND v.status = 'open';
...
SELECT
    ...
    (SELECT COUNT(*) FROM eval_prompt_datasets WHERE dataset_code = 'HRA-EVAL-V2') AS datasets,
    (SELECT COUNT(*) FROM eval_prompt_cases c
     JOIN eval_prompt_datasets d ON c.dataset_id = d.id
     WHERE d.dataset_code = 'HRA-EVAL-V2') AS cases_count,
    (SELECT COUNT(*) FROM eval_prompt_case_vacancies cv
     JOIN eval_prompt_cases c ON cv.case_id = c.id
     JOIN eval_prompt_datasets d ON c.dataset_id = d.id
     WHERE d.dataset_code = 'HRA-EVAL-V2') AS case_vacancies_count;
