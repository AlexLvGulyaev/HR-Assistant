...
Positive сценарии прошли, но negative сценарии провалились. Модель не умеет корректно отклонять нерелевантные и edge-case профили. Это главное открытие Experiment 002:
...
**Статус:** Технический отчёт Experiment 002
