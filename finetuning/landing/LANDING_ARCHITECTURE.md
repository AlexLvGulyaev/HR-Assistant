...
Повествовательная спецификация — внутренний документ, хранится вне публичного репозитория.  
...
- [`assets/visuals/lumina-evolution.svg`](assets/visuals/lumina-evolution.svg) — схема эволюции Люмины для внутренней повествовательной спецификации, не используется в HTML.
...
| Повествовательная спецификация | внутренний документ (вне публичного репозитория) | Описывает смысл каждой сцены |
...
|-----------|-------------|----------------|------------|
| Структура или тексты сцен в `index.html` | внутренняя повествовательная спецификация (при смысловом изменении), `VISUAL_ASSETS_REGISTRY.md` (при добавлении SVG) | `css/main.css`, `js/app.js`, если разметка не меняется | Редактируется вручную |
...
4. При смысловом изменении повествования — обновить внутреннюю повествовательную спецификацию.
...
- внутренняя повествовательная спецификация — при изменении повествования.
