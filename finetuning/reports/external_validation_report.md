...
## 📈 4. Предсказания моделей на этом датасете
...
**Model prediction (LoRA Experiment 004):** `no_match`, score 57, с обоснованием, что кандидат — AI Automation Specialist, а не системный аналитик, и не хватает профильных hard skills.
...
**Статус:** Отчёт по внешнему датасету HRA-EVAL-V5-EXT
