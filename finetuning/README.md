...
| Эксперимент | Что проверяли | Результат | Вердикт | Следующий инженерный вопрос |
|-------------|---------------|-------------------|---------|------------------------------|
...
- Ре-разметка hard negatives с жёстким критерием (BA/DA/process analyst → `no_match` без прямых профильных навыков).
